...
frozen_infer_graph_path = "object_detection/ssdlite_mobilenet_v2_traffic_cone/frozen_inference_graph.pb"
label_map_path = "object_detection/graph.pbtxt"
...
# Load image to model
image_path = "object_detection/dataset/test_set/33.jpg"
image = cv.imread(image_path)

(h, w) = image.shape[:2]

image = cv.resize(image, (300, 300))
blob = cv.dnn.blobFromImage(image, scalefactor = 1.0, (300, 300))
